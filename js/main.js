...
const App = {
    ...
    bindEvents() {
        // Drag & Drop
        document.addEventListener('dragover', (e) => { e.preventDefault(); e.stopPropagation(); D.body.classList.add('drag-over'); });
        ...
        D.searchInput.addEventListener('keydown', (e) => { if (e.key === 'Enter') { e.preventDefault(); Search.perform(); }});
